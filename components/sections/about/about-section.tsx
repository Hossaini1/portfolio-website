...
export default function AboutSection({ t }: { t: AboutType }) {
  return (
    <section id="about" className="dark:bg-background mt-17 md:mt-27 lg:mt-41">
      ...
      {/* Lazy load CloudLogo components*/}
      <Suspense fallback={<div className="h-40 bg-muted/20 animate-pulse my-8" />}>
        <CloudLogo 
          direction="right" 
...
// Memoized IntegrationCard to prevent unnecessary re-renders
