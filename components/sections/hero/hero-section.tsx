      ...
      <div className=" mt-17 md:mt-27 lg:mt-37 flex items-center justify-center h-full">
        ...
        <div className="relative z-10 text-center max-w-3xl">
          <Badge
            ...
            asChild
          >
            <Link href="https://en.wikipedia.org/wiki/Web3" target="_blank" className="text-[.6rem] md:text-sm">
          ...
          <div className="mt-12 flex items-center justify-center gap-4">
            <Button size="lg" className="rounded-full px-4 md:py-5.5 md:px-12">
              <Link href="https://github.com/Hossaini1" className="flex justify-center items-center gap-2 text-[0.68rem] md:text-base " target="_blank">{t?.btn?? "View My Works"}<ArrowUpRight className="h-3.5! w-3.5! md:h-5! md:w-5!" /></Link>
            </Button>
          </div>
        </div>
      </div>
