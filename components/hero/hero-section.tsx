...
const HeroSection = ({t}:{t:HeroType}) => {
  return (
    <>
      <div className=" pt-25 md:pt-31 lg:pt-37 flex items-center justify-center h-full">
        <BackgroundPattern  />
        <div className="relative z-10 text-center max-w-3xl">
          ...
          <div className="mt-12 flex items-center justify-center gap-4">
            <Button size="lg" className="rounded-full text-base md:py-5.5">
              <Link href="https://github.com/Hossaini1" className="flex justify-center items-center gap-2 text-sm md:text-lg" target="_blank">{t?.btn?? "View My Works"}<ArrowUpRight className="h-5! w-5!" /></Link>
            </Button>
          </div>
        </div>
      </div>
