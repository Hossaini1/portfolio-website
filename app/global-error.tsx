    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="text-center p-8 bg-white shadow-2xl rounded-xl max-w-lg w-full">
        ...
        {process.env.NODE_ENV === "development" && (
          <div className="text-left bg-gray-100 p-3 rounded-md text-red-700 font-mono text-sm mb-8 border border-red-300">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button
            onClick={() => reset()}
            className="px-8 py-3 text-lg font-semibold rounded-full shadow-lg text-white bg-red-600 hover:bg-red-700"
          >
