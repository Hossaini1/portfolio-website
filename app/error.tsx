...
export default function Error({
  ...
  return (
    <>
      <head>
        <title>Error | Ali Naghi Hossaini</title>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center p-8 bg-white shadow-2xl rounded-xl max-w-lg w-full transform transition-all duration-300">
          ...
          <p className="text-lg text-gray-600 mb-10">
            An unexpected error occurred. Please try to refresh the page or return to the homepage.
          </p>

          {process.env.NODE_ENV === 'development' && (
            <div className="text-left bg-gray-100 p-3 rounded-md text-red-700 font-mono text-sm mb-8 overflow-x-auto">
