...
export const metadata: Metadata = {
  ...
  description:
    "The requested page could not be found. Please return to the homepage to explore Ali Naghi Hossaini's full stack developer portfolio.",
  robots: {
    index: false,
    follow: true,
  },
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="text-center p-8 bg-white shadow-2xl rounded-xl max-w-lg w-full">
        <h1 className="text-8xl font-black text-indigo-700 mb-6">404</h1>
